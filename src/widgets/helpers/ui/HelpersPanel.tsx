...
export function HelpersPanel({ onOpenIsins, onOpenSettings, onOpenAccount }: HelpersPanelProps) {
	return (
		<div className="border-b border-[#1e1e2e] px-3 py-2.5 space-y-1.5">
			...
			<div className="flex flex-wrap gap-1.5">
				<Pill icon={<Hash className="h-3 w-3" />} label="ISINs" onClick={onOpenIsins} />
				<Pill icon={<Settings className="h-3 w-3" />} label="Settings" onClick={onOpenSettings} />
				<Pill
