...
import { Check, Link, LogIn, QrCode, Upload, UserPlus, X } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[#1e1e2e]">
        ...
        <section className="p-5 space-y-3">
          <div className="space-y-1">
            <h3 className="text-[12px] uppercase font-bold text-zinc-500">
              No account needed
            </h3>
            <p className="text-[12px] text-zinc-500">
              Export your watchlist as a URL or QR code. Save it anywhere —
              paste it back later to restore. No sign-in required.
            </p>
          </div>
        ...
        <section className="p-5 space-y-3">
          <div className="space-y-1">
            ...
            <p className="text-[12px] text-zinc-500">
              Log in or register to keep your watchlist synced and always up to
              date — no manual exports, available from any device.
            </p>
          </div>
          <div className="flex flex-col gap-2">
            <button
